...
public class HolaApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(HolaApp.class);

    private final Environment env;

    public HolaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HolaApp.class);
